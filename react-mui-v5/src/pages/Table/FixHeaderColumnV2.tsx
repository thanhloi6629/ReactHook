    ...
    <div>
      <TableContainer component={Paper} sx={tableContainerSx}>
        <Table stickyHeader={true}>
          ...
          >
            {list.personEvaluated.map((address, index) => (
              <TableRow key={address.staffID}>
                <TableCell
                  scope="row"
                  component="th"
                  style={{
                ...
                <TableCell scope="row">{address.positionName}</TableCell>
                {list.assessor
                  ...
                  .map((it) => (
                    <>
                      ...
                      <TableCell scope="row">{it.staffName}</TableCell>
                      <TableCell scope="row">{it.positionName}</TableCell>
                    </>
                  ))}
              </TableRow>
            ))}
